            ...
            _this.asArray(key, function (keys) {
                ...
                for (var index in keys) {
                    ...
                    if (value !== null) {
                        ...
                        errors.push({ key: key_1, error: "".concat(StorageType[_this.storageType], " storage: value with key \"").concat(key_1, "\" was not found!") });
                    }
                }
                ...
                if (value !== null) {
                    ...
                    reject({ key: key, error: "".concat(StorageType[_this.storageType], " storage: value with key \"").concat(key, "\" was not found!") });
                }
            });
        });
    };
            ...
            _this.asArray(data, function (data) {
                ...
                for (var index in data) {
                    ...
                    try {
                        ...
                        errors.push({ key: key, error: "".concat(StorageType[_this.storageType], " storage: value with key \"").concat(key, "\" could not be set!") });
                    }
                }
                ...
                try {
                    ...
                    reject({ key: data.key, error: "".concat(StorageType[_this.storageType], " storage: value with key \"").concat(data.key, "\" could not be set!") });
                }
            ...
            _this.asArray(key, function (keys) {
                ...
                for (var index in keys) {
                    ...
                    if (_this.storage.getItem(key_2) !== null) {
                        ...
                        errors.push({ key: key_2, error: "".concat(StorageType[_this.storageType], " storage: value with key \"").concat(key_2, "\" could not be removed!") });
                    }
                }
                if (errors.length === keys.length) {
                    reject(errors);
                ...
                if (_this.storage.getItem(key) !== null) {
                    ...
                    reject({ key: key, error: "".concat(StorageType[_this.storageType], " storage: value with key \"").concat(key, "\" could not be removed!") });
                }
            });
        });
    };
